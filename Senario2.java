...
//                        }
            ...
            broker.submitCloudletList(listT);
                        ...
                        //declaring an array to see how many task are assigned to each vm
                        int [] tm={0,0,0,0} ;
	...
	private static void printCloudletList(List<Cloudlet> list) {
		...
		Log.printLine("Cloudlet ID" + indent + "STATUS" + indent +
				 indent + "VM ID" + indent + "Priority" + indent + "Time" + indent + "Start Time" + indent + "Finish Time");
		...
		for (int i = 0; i < size; i++) {
			...
			if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS){
				...
				Log.printLine(indent + indent + indent + cloudlet.getVmId() +
						indent + indent + cloudlet.getPriority() + indent + indent + dft.format(cloudlet.getActualCPUTime()) +
